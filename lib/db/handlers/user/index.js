...
class UserChangeHandler {
    ...
    init(transport) {
        ...
        this.isPrepared = !!this.transport
    }
    ...
    sendUserChange = (user, isAddedGroup, groups, action, targets) => {
        ...
        // UserChange is a broadcast-to-app: the proxy fans it out to all
        // registered broadcast receivers (websocket) for client-side filtering.
