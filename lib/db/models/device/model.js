...
// Returns every device with only the fields needed to compute its state, whatever the group it
// belongs to; reserved to privileged (admin) operations
export const getDevicesForMetrics = function() {
    return db.devices.find({}, {
        projection: {
            _id: 0,
            present: 1,
