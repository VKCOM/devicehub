...
import {AutoGroupMessage, GroupMessage, UngroupMessage} from '../../../wire/wire.js'
export default syrup.serial()
    ...
    .define(async function(options, solo, ident, /** @type {any} */ service, router, push, sub, channels) {
        ...
        router
            .on(GroupMessage, function(channel, message) {
            ...
            .on(AutoGroupMessage, function(channel, message) {
            ...
            .on(UngroupMessage, function(channel, message) {
                let reply = wireutil.reply(options.serial)
                grouputil.match(ident, message.requirements)
                    .then(function() {
