...
const wireutil = {
     ...
     * Not deprecated yet..
     */
    transaction(channel: string, messageType: MessageType<object>, ...args: unknown[]) {
        return this.oldSend(messageType, args, channel)
    },

    oldSend(message: object, args: unknown[], channel: string | undefined = undefined) {
        // @ts-expect-error
