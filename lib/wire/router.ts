...
export class WireRouter extends EventEmitter {
    ...
    on(eventOrMessage: EventType, fn: (...args: any[]) => void, context?: any): this {
    ...
    removeListener(event: string | symbol, fn: (...args: any[]) => void, context?: any): this
    removeListener(message: WireMessage, fn: (...args: any[]) => void): this
    removeListener(eventOrMessage: EventType, fn: (...args: any[]) => void, context?: any): this {
        if (typeof eventOrMessage === 'object' && '$code' in eventOrMessage) {
            super.removeListener(eventOrMessage.$code, fn)
        } else {
            super.removeListener(eventOrMessage as string | symbol, fn, context)
        }
        return this
    }
