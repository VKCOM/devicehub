...
export const builder = function(yargs) {
    return yargs
        ...
        .option('connect-processor', {
            alias: 'p',
            describe: 'Processor ZeroMQ ROUTER endpoint the forked devices connect to.',
            array: true,
            demand: true
        })
...
export const handler = function(argv) {
    ...
    return provider({
        ...
        fork: function(serial, ports, processorEndpoint) {
            var args = [
                'device',
                '--serial', serial,
                ...
                '--connect-processor', processorEndpoint
            ]
        ...
        endpoints: {
            processor: argv.connectProcessor
        },
        adbHost: argv.adbHost,
        adbPort: argv.adbPort,
        adbAutostart: argv.adbAutostart,
        adbPath: argv.adbPath,
        idleDeviceReconnect: argv.idleDeviceReconnect,
